...
video_urls = [
    "https://www.youtube.com/watch?v=oS9ajaVNqkw", 
    "https://www.youtube.com/watch?v=Q4xQdgcxGns",
    "https://www.youtube.com/watch?v=5vK8LEgznBQ"
]
...
for i, url in enumerate(video_urls):
    try:
        print(f"\nProcessing podcast {i+1}/{len(video_urls)}: {url}")
...
print("Podcast crawling complete.")